...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'jobs',
        loadComponent: () =>
          import('./pages/jobs/job-list/job-list').then((m) => m.JobListComponent),
      },
      {
        path: 'jobs/create',
        loadComponent: () =>
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./pages/proposals/job-proposals/job-proposals').then(
            (m) => m.JobProposalsComponent,
          ),
      },
      {
        path: 'freelancers',
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./pages/proposals/proposal-list/proposal-list').then(
            (m) => m.ProposalListComponent,
          ),
      },
      {
        path: 'contracts',
        loadComponent: () =>
          import('./pages/contracts/contract-list/contract-list').then(
