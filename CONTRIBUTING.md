...
- We use **Prettier** for code formatting. You can run it manually using:
  ...
  npm run format
  ```
- Follow the existing architectural patterns (Controllers, Services, Models in the backend; Components, Services in Angular).
...
- `frontend-react/`: (Future) React application.
